export const TextSkeleton = ({ ...rest }: DivProps) => {
  return (
    <div
      role="status"
    ...
    >
      <div className="flex w-full flex-wrap items-center gap-y-1 sm:flex-nowrap">
        <div className="h-2.5 w-28 min-w-64 rounded-full bg-gray-200 dark:bg-gray-700"></div>
        <div className="ms-2 h-2.5 w-2.5 min-w-52 rounded-full bg-gray-300 dark:bg-gray-600"></div>
