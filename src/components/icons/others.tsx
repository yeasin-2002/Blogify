...
export const CrossRoute = ({ className, ...rest }: SvgProp) => (
  <svg
    {...rest}
    className={cn(className)}
    data-slot="icon"
...
export const CrossRound = ({ className, ...rest }: SvgProp) => (
  <svg
    {...rest}
...
export const SearchIcon = ({ className, ...rest }: SvgProp) => (
  <svg
    {...rest}
    xmlns="http://www.w3.org/2000/svg"
    width="24"
...
export const EyeOpen = ({ className, ...rest }: SvgProp) => (
  <svg
    className={cn(className)}
    {...rest}
    xmlns="http://www.w3.org/2000/svg"
...
export const EyeClose = ({ className, ...rest }: SvgProp) => (
  <svg
    className={cn(className)}
    {...rest}
    xmlns="http://www.w3.org/2000/svg"
